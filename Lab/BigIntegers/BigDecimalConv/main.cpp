...
int main(int argc, char** argv) {
    ...
    char number1[]="1111234569876543210987654321099999999";
    char number2[]="234567890123456789123";
    char result[sizeResult(number1,number2)];
    //Add the numbers
    cout<<setw(40)<<number1<<endl;
    cout<<setw(40)<<number2<<endl;
    bool x=numberAdd(number1,number2,result);
    if(x)cout<<"overflow"<<endl;
    else cout<<setw(40)<<result<<endl;
